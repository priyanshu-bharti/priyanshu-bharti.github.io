...
export default function Card({ title, desc, src, alt, list, grad, sh }) {
  ...
  return (
    <div data-aos="fade-in" data-aos-delay="300" className={`shadow-xl md:hover:scale-105 bg-slate-50 md:hover:bg-white transition-transform rounded-lg overflow-hidden flex flex-col mb-5 md:mb-0`}>
